"""
Cross-Scenario Stress Event Identification — Historical Dataset
===============================================================
Identifies weather-driven stress events from ZEN-garden historical climate outputs.
...
Inputs:
  ZEN-garden historical output folder (PATH)

Outputs:
  ~/Desktop/Bachelor Thesis/CSVs_and_JSONs/historical/events_global_alpha/events_global_historical_alpha{XX}.csv
...
OUT_DIR       = '~/Desktop/Bachelor Thesis/CSVs_and_JSONs/historical/events_global_alpha'
# ──────────────────────────────────────────────────────────────────────────────
...
for alpha in ALPHAS:
    ...
    # Save events to CSV
    csv_path = os.path.join(OUT_DIR, f'events_global_historical_alpha{int(alpha * 100):02d}.csv')
