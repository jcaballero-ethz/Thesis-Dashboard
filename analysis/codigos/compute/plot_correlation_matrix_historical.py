...
Outputs:
  htmls/fotos/corr_historical_wind_anom.png
  htmls/fotos/corr_historical_pv_anom.png
  htmls/fotos/corr_historical_heat_anom.png
  htmls/fotos/corr_historical_combined.png  (average of 3 matrices, with zone boxes)
"""
